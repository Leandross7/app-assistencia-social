...
const CACHE_NAME = 'atendimentos-cache-v6'; // Versão incrementada
...
const urlsToCache = [
  ...
  'https://www.gstatic.com/firebasejs/11.6.1/firebase-functions.js' // <-- ADICIONADO PARA CLOUD FUNCTIONS
];
...
self.addEventListener('install', event => {
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => {
        console.log('Cache aberto e arquivos sendo salvos para a v6.');
